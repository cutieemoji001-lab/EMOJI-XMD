...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY EMOJI-XMD🤍*",
...
BOT_NAME: process.env.BOT_NAME || "EMOJI-XMD",
STICKER_NAME: process.env.STICKER_NAME || "EMOJI-XMD",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "254794146821",
OWNER_NAME: process.env.OWNER_NAME || "emoji-xmd",
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ hendrexx*",
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/fgiecg.jpg",
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *EMOJI-XMD*⚡",
